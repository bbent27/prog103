...
#this is telling us how many hours per day (out of the days recorded) it is
#below -4 degrees in Nuka pass in late winter
...
extreme_temp("Nuka_Pass", "Spring", "hot")
